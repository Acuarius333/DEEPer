...
<head>
    ...
    <main>
        <section class="home-intro">
            <h1><?php echo $stmt->name?> this is your personal section</h1>
        </section>
    </main>
    <h4 style="color: white; margin-left: 300px; margin-top: -50px">Your reviews</h4>
    <h4 style="color: white; margin-left: 1000px; margin-top: -50px">Your options</h4>

    <button class="open-button1" onclick="openForm1()">Upload profile picture</button>
    <div class="form-popup" id="myForm1">
        <form name="form1" id="form1" method="post" enctype="multipart/form-data" action="../src/php/upload_user_image.php" class="form-container">
            <h1>Upload your profile picture:</h1>

            <input type="file" name="fileToUpload" id="fileToUpload" required>
            <button type="submit" name="submit" id="submit" class="btn">Submit</button>
        </form>
            <button type="submit" name="close" id="close" class="btn cancel" data-dismiss="form" onclick="closeForm1()">Close</button>

    </div>

    <button class="open-button2" onclick="openForm2()">Change profile picture</button>
    <div class="form-popup" id="myForm2">
        <form method="post" enctype="multipart/form-data" action="../src/php/change_user_image.php" class="form-container">
    ...
    <div class="form-popup" id="myForm3">
        <form method="post" enctype="multipart/form-data" action="../src/php/change_password.php" class="form-container">
            ...
            <input class="text" type="password" name="password" id="password" placeholder="New password" autocomplete="off" required>
            <input class="text" type="password" name="confirmPassword" id="confirmPassword" placeholder="Confirm new password" autocomplete="off" required>
    ...
    <button class="open-button4" onclick="openForm()">Delete account</button>


<?php

foreach ($checkIn as $checkIns){
    $_SESSION['checkin_id'] = $checkIns->id;
    ...
    include '../src/php/Templates/stars_rating_php_format.php';
        echo "<div style='margin-left: 2em; z-index: 2'>
                <div class='blog-card'>
                    ...
                    <a class='open-button5' style='text-align: center; text-decoration: none;'href='../src/php/delete_checkin.php'>Delete</a>
