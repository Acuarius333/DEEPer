...
elseif ($averageRating <= 4.50){
    ...
    $averageRating = '<img style="position: absolute; display: block; width: 250px; height: 56px; margin-top: -35px; margin-left: 170px"src="https://upload.wikimedia.org/wikipedia/commons/1/17/Star_rating_5_of_5.png">';}
?>